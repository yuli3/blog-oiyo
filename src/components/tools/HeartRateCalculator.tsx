...
const L: Record<string, UiLabels> = {
  ...
  cn: { age: "年龄", resting: "静息心率 (可选)", restingHint: "输入静息心率可用卡氏(储备心率)区间计算。", maxHr: "最大心率", bpm: "bpm", zones: "目标心率区间", zoneNames: ["Z1 恢复 (50–60%)", "Z2 耐力 (60–70%)", "Z3 有氧 (70–80%)", "Z4 阈值 (80–90%)", "Z5 最大 (90–100%)"], method: "最大心率 = 220 − 年龄" },
