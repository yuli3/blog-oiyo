    ...
    <div className="not-prose my-10 p-4 sm:p-8 bg-white border border-slate-200 rounded-3xl shadow-xl max-w-2xl mx-auto space-y-8">
      ...
      <div className="flex justify-center pt-4">
        <button
          ...
          className={`px-5 sm:px-10 py-3 rounded-2xl font-bold text-base transition-all ${isComplete ? "bg-slate-700 text-white hover:bg-slate-800 shadow-lg" : "bg-slate-200 text-slate-400 cursor-not-allowed"}`}
        >
