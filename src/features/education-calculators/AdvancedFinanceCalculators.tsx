    ...
    return (
        <Card className="p-4 sm:p-6 bg-slate-900 border-slate-800 text-white shadow-xl mt-5 sm:mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
                ...
                <div className="flex flex-col justify-center items-center bg-blue-500/5 rounded-2xl border border-blue-500/20 p-4 sm:p-6">
    ...
    return (
        <Card className="p-4 sm:p-6 bg-slate-900 border-slate-800 text-white shadow-xl mt-5 sm:mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
                ...
                <div className="flex flex-col justify-center items-center bg-emerald-500/5 rounded-2xl border border-emerald-500/20 p-4 sm:p-6">
