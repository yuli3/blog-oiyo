...
tags:
  ...
  - 역전파
  - 활성화함수
description: "인공신경망의 구조, 활성화 함수, 역전파 알고리즘, CNN과 RNN의 차이 — AI·머신러닝 기초."
pubDate: '2026-05-31'
---
...
$$
\text{출력} = \text{활성화함수}(\sum(\text{가중치} \times \text{입력}) + \text{편향})
$$
...
$$
\text{가중치} \leftarrow \text{가중치} - \text{학습률} \times \partial \text{손실}/\partial \text{가중치}
$$
