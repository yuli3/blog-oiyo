...
<FrontierChart title="효율적 프론티어와 최적 포트폴리오" client:visible />
...
<LectureProcess
  steps={[
    ...
    },
    {
      label: "최적화 실행 (QP)",
      description:
        "이차 계획법(Quadratic Programming) 알고리즘으로 각 자산의 구체적 비중(W)을 도출합니다.",
    },
  ]}
  client:visible
/>
...
- [**금융공학 심화: 금융 머신러닝 기초**](/ko/education-financial-engineering-ch11/)
- [**보험수리 심화: IFRS17과 최신 계리 실무**](/ko/education-actuarial-science-ch10/)
