...
$$
\begin{aligned}
\text{매출총이익률}(Gross Margin) &= \text{매출총이익} / \text{매출액} \\
\text{영업이익률}(Operating Margin) &= \text{영업이익} / \text{매출액} \\
\text{순이익률}(Net Profit Margin) &= \text{당기순이익} / \text{매출액} \\
ROE(\text{자기자본이익률)} &= \text{당기순이익} / \text{평균 자기자본} \\
ROA(\text{총자산이익률)} &= \text{당기순이익} / \text{평균 총자산}
\end{aligned}
$$
...
$$
\begin{aligned}
\text{유동비율}(Current Ratio) &= \text{유동자산} / \text{유동부채} \\
\text{당좌비율}(Quick Ratio) &= (\text{유동자산} - \text{재고)} / \text{유동부채} \\
\text{현금비율}(Cash Ratio) &= \text{현금 및 현금성자산} / \text{유동부채}
\end{aligned}
$$
...
$$
\begin{aligned}
\text{부채비율}(Debt-to-Equity) &= \text{총부채} / \text{자기자본} \\
\text{이자보상배율}(Interest Coverage) &= EBIT / \text{이자비용}
\end{aligned}
$$
