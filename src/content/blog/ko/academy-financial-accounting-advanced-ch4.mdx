...
track: academy
locale: ko
title: "재무제표분석 — 회계 숫자와 가치평가"
category: "Finance"
series: financial-statement-analysis
chapter: 6
chapterTitleShort: '중급회계 · 기업 가치 평가'
author: OIYO 편집부
tags:
  - 기업가치평가
  - DCF
...
$$
\text{기업 가치} = \sum (\text{미래} \frac{FCF}{1+WACC}^n) + \text{터미널 가치}
$$
...
$$
\begin{aligned}
WACC &= (\frac{E}{V} \times \text{Re}) + (\frac{D}{V} \times \text{Rd} \times (1-T)) \\
E &= \text{자기자본 시가}, D = \text{부채 시장가치} \\
V &= E+D (\text{총 자본}) \\
\text{Re} &= \text{자기자본 비용} (CAPM\text{으로 계산}) \\
\text{Rd} &= \text{부채 비용} (\text{이자율}) \\
T &= \text{법인세율}
\end{aligned}
$$
...
$$
\text{터미널 가치} = FCF_n+\frac{1}{WACC - \text{영구 성장률}}
$$
...
$$
\begin{aligned}
\text{기업 가치}(EV) &= \sum [\frac{\text{FCFt}}{1+WACC}^t] + \frac{TV}{1+WACC}^n \\
\text{주식 가치} &= EV - \text{순부채} \\
\text{주당 가치} &= \frac{\text{주식 가치}}{\text{발행주식수}}
\end{aligned}
$$
...
$$
\begin{aligned}
EV(\text{기업가치}) &= \text{시가총액} + \text{순부채} \\
\frac{EV}{EBITDA} &= \frac{EV}{EBITDA}
\end{aligned}
$$
...
$$
\begin{aligned}
NAV &= \text{자산의 공정 가치} - \text{부채의 공정 가치} \\
\text{주당} NAV &= \frac{NAV}{\text{발행주식수}}
\end{aligned}
$$
