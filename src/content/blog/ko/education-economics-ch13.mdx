...
중앙은행이 공급한 본원통화는 상업은행의 대출 과정으로 실질 통화량으로 확대된다.
...
지준율 10%, 현금비율 20%, 초과지준 0. 승수는 (1.2)/(0.3)=4다. 단순 10이 아니다. 본원 1조 원이 통화 4조 원이다.
