...
track: academy
locale: ko
title: "빅데이터 분석기사 — Python 실기 완전 정복"
category: "Exam"
series: "빅데이터 분석기사"
chapter: 3
...
| 유형 | 배점 | 내용 |
|---|---|---|
| 단답형 | 10점 | 데이터 분석 용어, 통계 개념 5~10문항 |
| 작업형 1유형 | 20점 | 데이터 전처리 + 특정 값 계산 후 출력 (pandas, numpy 활용) |
| 작업형 2유형 | 40점 | 머신러닝 모델 학습 → 예측 → CSV 저장 (sklearn 활용) |
