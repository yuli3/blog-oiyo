...
tags:
  ...
  - SQL인젝션
  - XSS
description: "SDLC 보안, OWASP Top 10(SQL Injection/XSS/CSRF 등), 입력 검증, 보안 테스팅. CISSP."
pubDate: '2026-05-31'
---
...
$$
/\frac{\text{user}}{\text{profile}}?\text{id}=1234 \to \text{공격자가} \text{id}=1235\text{로 변경해 타인 프로필 접근}
$$
