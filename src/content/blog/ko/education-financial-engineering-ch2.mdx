...
<NPVChart title="할인율에 따른 사업 가치 변화 (NPV)" client:visible />
...
- [**회계학 마스터: 재무제표의 이해**](/ko/education-accounting-ch1/)
- [**보험수리 입문: 불확실성을 계산하는 기술**](/ko/education-actuarial-science-ch1/)
