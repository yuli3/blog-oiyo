...
chapter: 13
title: "거시경제학 — 경제 안정화 정책과 재정·통화 정책의 실전"
...
인플레 2% 목표 아래에서 실업이 자연실업보다 높으면 금리 인하가 1차 후보다. 공급 충격이면 같은 인하가 기대 인플레를 올려 비용이 커진다. 도구 하나에 목표 둘이다.
