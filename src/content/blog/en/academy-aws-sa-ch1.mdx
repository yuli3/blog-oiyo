...
track: academy
locale: en
title: "AWS SAA Exam Overview and Global Infrastructure"
category: "Exam"
...
tags:
  ...
  - certification
  - Solutions Architect
description: "AWS SAA-C03 exam overview, global infrastructure (Regions/AZs/Edge), cloud computing models, and the Shared Responsibility Model. AWS SAA."
pubDate: '2026-05-31'
---
...
User → Nearest Edge Location → (cache hit) → Response → (cache miss) → Origin → Cache → Response
...
$$
\begin{aligned}
\text{Customer}: "\text{My data}, \text{my app}, \text{my OS}, \text{my network config} &= \text{my responsibility}" \\
AWS: "\text{Data centers}, \text{servers}, \text{storage}, \text{networking hardware} &= \text{our responsibility}"
\end{aligned}
$$
