...
- **Term Life**: pays only if death occurs within the policy term (no benefit if the insured outlives the term)
...
- **Net/pure premium**: funds claims → Mortality (risk) component + Savings component
