...
track: academy
locale: en
title: "Cost Budgets and Variance Analysis Explained"
category: "Accounting"
...
tags:
  ...
  - variance analysis
  - efficiency variance
description: "Fixed versus flexible budgets, and how price, volume and efficiency variances reveal where cost control actually broke down."
pubDate: '2026-05-22'
---
...
$$
\text{Flexible Budget} = \text{budget recomputed at the actual production volume achieved}
$$
...
$$
\begin{aligned}
&\text{Static Budget Variance} \\
&= \text{Actual Cost} − \text{Fixed Budget Cost} \\
&\text{Volume Variance} \\
&= \text{Flexible Budget Cost} − \text{Fixed Budget Cost} \\
&\text{Controllable Variance} \\
&= \text{Actual Cost} − \text{Flexible Budget Cost}
\end{aligned}
$$
...
$$
\text{Static Budget Variance} = \text{Actual Cost} − \text{Fixed Budget Cost}
$$
...
$$
\text{Volume Variance} = \text{Flexible Budget Cost} − \text{Fixed Budget Cost}
$$
...
$$
\text{Price Variance} = \text{Actual Quantity} \times (\text{Standard Price} − \text{Actual Price})
$$
...
$$
\text{Efficiency Variance} = \text{Standard Price} \times (\text{Standard Quantity Allowed} − \text{Actual Quantity Used})
$$
