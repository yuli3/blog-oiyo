...
track: academy
locale: en
title: "Capital Budgeting — Making Investment Decisions with NPV, IRR, and Payback Period"
category: "Business"
...
$$
\begin{aligned}
NPV &= \$6,\frac{000}{1.10} + \$7,\frac{000}{1.10}^2 − \$10,000 \\
&= \$5,454.5 + \$5,785.1 − \$10,000 \\
&= +\$1,239.6 \to \text{Accept}
\end{aligned}
$$
...
$$
\begin{aligned}
PI &= \text{PV of future cash flows} / \text{Initial investment} \\
&= (NPV + \text{Initial investment}) / \text{Initial investment}
\end{aligned}
$$
