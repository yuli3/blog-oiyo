...
track: academy
locale: en
title: "Money, Banking & Monetary Policy — The Fed and Interest Rates"
category: "Economics"
...
**Three Functions of Money**
  ...
  1. Medium of Exchange: eliminates the double-coincidence-of-wants problem
  2. Store of Value: preserves purchasing power over time
  3. Unit of Account: common measure for comparing prices
...
**Expansion of the Monetary Base**
  ...
  1. Open market purchase (Fed buys Treasuries)
  2. Fed discount window lending (repos, advances)
