...
$$
\begin{aligned}
\text{Number of channels} &= n(n − 1) \div 2 \\
(n &= \text{number of team members}) \\
\text{Example}: 10-\text{person team} &= 10 \times 9 \div 2 = 45 \text{channels} \\
&\to \text{As team size grows}, \text{communication complexity grows exponentially}
\end{aligned}
$$
