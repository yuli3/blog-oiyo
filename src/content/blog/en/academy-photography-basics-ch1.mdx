...
$$
\begin{aligned}
EV &= \text{log}_{2}(\frac{f^2}{t}) \\
&f: f-\text{number}, t: \text{shutter speed} (\text{in seconds}) \\
\text{Example}: \frac{f}{2,} \frac{1}{30s} \to EV &= \text{log}_{2}(\frac{4}{0.033}) \approx 7
\end{aligned}
$$
...
<HighlightBox title="Examples in practice">
...
<HighlightBox title="The exposure meter">
