...
track: academy
title: "Project Integration Management — The Art of Holding Everything Together"
...
$$
\begin{aligned}
&\text{The master document that integrates all subsidiary plans}: \\
&\text{Scope Management Plan} + \text{Schedule Management Plan} + \text{Cost Management Plan} \\
&+ \text{Quality Management Plan} + \text{Resource Management Plan} + \text{Communications Plan} \\
&+ \text{Risk Management Plan} + \text{Procurement Management Plan} \\
&= \text{Project Management Plan} \\
&\to \text{Establishes baselines} (\text{scope}, \text{schedule}, \text{cost}) \\
&\to \text{All future changes are measured against these baselines}
\end{aligned}
$$
