...
$$
\text{Gross Rental Yield} = \frac{\text{Annual Rent}}{\text{Purchase Price}} \times 100
$$
...
$$
\begin{aligned}
NOI &= \text{Annual Rent} − \text{Operating Expenses} (\text{taxes}, \text{insurance}, \text{maintenance}, \text{vacancy}) \\
\text{Cap Rate} &= \frac{NOI}{\text{Purchase Price}} \times 100
\end{aligned}
$$
