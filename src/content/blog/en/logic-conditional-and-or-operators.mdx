...
locale: en
---
In [Ch1: Converse, Inverse, and Contrapositive](/ko/logic-foundations-converse), we learned the structure of the conditional statement A→B, and in [Ch2: Symbolic Logic Operators](/ko/symbolic-logic-operators), we practiced the basic truth tables for ∧ (AND), ∨ (OR), and ¬ (NOT).
