...
tags:
  ...
  - TF-IDF
  - sentiment analysis
description: "TF-IDF, morphological analysis, sentiment analysis, LDA topic modeling, Apache Spark — the final chapter of Big Data Analytics."
pubDate: '2026-05-31'
---
...
$$
TF(t, d) = \text{count of term} t \text{in doc} \frac{d}{\text{total terms in doc}} d
$$

**IDF (Inverse Document Frequency)**: How rare the term is across all documents.
$$
IDF(t) = \text{log}(\frac{\text{total documents}}{\text{documents containing}} t)
$$
