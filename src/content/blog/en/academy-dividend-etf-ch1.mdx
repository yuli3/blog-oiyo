...
$$
\text{Dividend Yield} (\%) = (\text{Annual Dividends Per Share} \div \text{Current Price}) \times 100
$$

**Example**: JEPI trading at \$55, monthly dividend \$0.40
$$
\begin{aligned}
\text{Annual dividend} &= \$0.40 \times 12 = \$4.80 \\
\text{Dividend yield} &= (\$4.80 \div \$55) \times 100 = 8.7\%
\end{aligned}
$$
