...
tags:
  ...
  - ChatGPT
  - Stable Diffusion
description: "AI that creates images, writes text, and composes music. From GANs to diffusion models to GPT-4 — the core principles of generative AI."
pubDate: '2026-05-31'
---
...
- Generator: Creates fake data → Learns to fool
- Discriminator: Classifies real vs. fake → Learns to detect
...
**Training:**
1. Clean image
2. Gradually add Gaussian noise T times
3. Pure noise
4. Learn to reverse this process

**Generation:**
1. Pure random noise
2. Gradually remove noise T times
3. Generated image
