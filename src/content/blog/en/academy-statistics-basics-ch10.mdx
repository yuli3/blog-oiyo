...
Multiplication: P(A∩B) &= P(A) \times P(B|A) \\
Conditional: P(A|B) &= P(A∩B) / P(B) \\
Independence: P(A∩B) &= P(A) \times P(B)
\end{aligned}
$$
...
$$
\begin{aligned}
Slope: \beta_{1} &= r \times (sy/sx) \\
Intercept: \beta_{0} &= ȳ − \beta_{1}x̄ \\
Coefficient of det.: R^2 &= SSR/SST = 1 − SSE/SST
\end{aligned}
$$
