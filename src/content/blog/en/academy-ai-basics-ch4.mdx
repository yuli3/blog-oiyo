...
track: academy
locale: en
title: "NLP and LLMs: How Transformers Actually Work"
...
tags:
  ...
  - LLM
  - ChatGPT
description: "Tokenization, embeddings and attention explained, plus how BERT and GPT differ and what that means for prompt engineering."
pubDate: '2026-05-31'
---
...
$$
\mathrm{Attention}(Q,K,V) = \mathrm{softmax}(QK^{T}/\sqrt{d}) \times V
$$
