...
$$
\begin{aligned}
Simple interest: FV &= PV \times (1 + r \times n) \\
Compound interest: FV &= PV \times (1 + r)^n \\
PV &= Present Value \\
...
$$
\begin{aligned}
PV of growing perpetuity &= \frac{C}{r - g} (requires r > g) \\
Example: First-year payment \$1,000, growing 2\% per year, r &= 6\% \\
PV &= \$1,\frac{000}{0.06 - 0.02} = \$1,000 / 0.04 = \$25,000
\end{aligned}
$$
