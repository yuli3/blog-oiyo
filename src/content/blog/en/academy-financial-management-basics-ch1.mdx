...
\begin{aligned}
PV &= \frac{FV}{1 + r}^n \\
&= FV \times [\frac{1}{1 + r}^n] \\
&\text{Discount rate} (r): \text{the rate used to convert future cash flows into present value}
\end{aligned}
$$
...
$$
\begin{aligned}
&\$10,000 \text{to be received} 3 \text{years from now}, \text{discount rate} 10\% \\
PV &= \$\frac{10,000}{1.10}^3 = \$\frac{10,000}{1.331} \approx \$7,513
\end{aligned}
$$
