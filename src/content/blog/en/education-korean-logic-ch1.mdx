---
title: >-
  Public Enterprise Korean Language Logic Ch1. The basics of conditional
  statements and declarations — ~(A → B) and logical conversion
description: >-
  A lecture at the level of a first-class instructor that penetrates the essence
  of conditional sentences. You will learn the negation of ‘If A, then B’ (A ∧
  ~B) and the law of exchange with declaration (A∨B), and progress to difficult,
  practical problems.
