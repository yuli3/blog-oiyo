...
tags:
  ...
  - box plot
  - scatter plot
description: "Choosing the right chart, histograms, box plots, scatter plots, heatmaps, and dashboard design principles."
pubDate: '2026-05-31'
---
...
Reading left to right: the left whisker ends at the minimum, the box runs from Q1 to Q3 with a line at the median, and the right whisker ends at the maximum. Points drawn separately beyond the whiskers are outliers.
