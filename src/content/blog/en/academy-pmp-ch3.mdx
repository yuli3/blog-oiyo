...
title: "Scope, Schedule, and Cost Management — The Triple Constraint"
category: "Exam"
...
tags:
  ...
  - WBS
  - EVM
description: "WBS, scope creep, Critical Path Method (CPM), Earned Value Management (EVM) — managing the project triple constraint. PMP."
pubDate: '2026-05-31'
---
...
Scope, Schedule, and Cost sit at the three corners of a triangle: move one corner and at least one of the other two has to move with it.
...
- Activity A (3 days) → Activity C (2 days) → End (CPM = 8 days)
...
$$
\begin{aligned}
&\text{Mid-project checkpoint}: \\
PV &= \$500K (\text{planned to complete} \$500K \text{of work by now}) \\
EV &= \$400K (\text{only} \$400K \text{of work actually completed}) \\
AC &= \$480K (\text{spent} \$480K) \\
CV &= 400 - 480 = -80K (\text{over budget}) \\
SV &= 400 - 500 = -100K (\text{behind schedule}) \\
CPI &= \frac{400}{480} = 0.83 (\text{generating} \$0.83 \text{of value per dollar spent}) \\
SPI &= \frac{400}{500} = 0.80 (80\% \text{of planned progress achieved})
\end{aligned}
$$
