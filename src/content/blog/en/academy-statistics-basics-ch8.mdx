...
track: academy
locale: en
title: 'ANOVA — Testing Mean Differences Across Three or More Groups'
category: "Statistics"
...
$$
\begin{aligned}
\text{Total Variation} &= \text{Between}-\text{Group Variation} + \text{Within}-\text{Group Variation} \\
SST &= SSB + SSW
\end{aligned}
$$
...
$$
χ^2 = \sum[(\text{Observed} − \text{Expected})\frac{^2}{\text{Expected}}]
$$
