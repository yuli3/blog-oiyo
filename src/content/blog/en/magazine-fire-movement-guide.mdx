...
$$
\text{Target Portfolio} = \text{Annual Living Expenses} \times 25
$$
...
$$
\begin{aligned}
\text{Coast FIRE} &= \text{Current invested assets can grow} (\text{without additions}) \\
&\text{to your FIRE number by age} 65
\end{aligned}
$$
