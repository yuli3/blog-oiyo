...
track: academy
locale: en
title: 'Real Estate Tax Triple Play — Acquisition, Holding, and Sale Taxes Explained'
...
| --- | --- | --- |
| Transfer/Recording Tax (state/local) | Property Tax (state/local) | Capital Gains Tax (federal + state) |
| One-time charge | Annual charge | Tax on profit |
| Based on purchase price | Based on assessed value | Based on gain (sale − basis) |
...
- **Example**: Home with $350,000 market value, 100% assessment ratio, $12 per $1,000 mill rate (= 1.2% effective rate)
...
- **Step 1**: Adjusted Basis = $300,000 + $8,000 + $15,000 = $323,000

- **Step 2**: Gain = $700,000 − $323,000 − $21,000 = $356,000
