...
<HighlightBox title="Filing Result">
...
$$
\begin{aligned}
\text{Deduction tax saving} &= \text{Deduction amount} \times \text{Your marginal tax rate} \\
\text{Example}: \$1,000 \text{deduction} \times 22\% \text{rate} &= \$220 \text{tax reduction} \\
\text{Example}: \$1,000 \text{deduction} \times 32\% \text{rate} &= \$320 \text{tax reduction} \\
&\to \text{Higher-income taxpayers benefit more from deductions}
\end{aligned}
$$
...
- Credits are equally valuable at every income level; refundable credits can produce a refund even if no tax is owed
...
- **Substantiation required**: Receipt for any donation; qualified appraisal for non-cash contributions > $500

**Medical Expenses**
$$
\begin{aligned}
&\text{Only the amount exceeding} 7.5\% \text{of AGI is deductible} \\
&\text{Example}: \\
AGI &= \$50,000; \text{medical expenses} = \$6,000 \\
\text{Floor} &= \$50,000 \times 7.5\% = \$3,750 \\
\text{Deductible amount} &= \$6,000 − \$3,750 = \$2,250 \\
\text{Tax savings at} 22\% &= \$2,250 \times 22\% = \$495
\end{aligned}
$$
...
- After a life change (marriage, new child, second job), update your W-4 using the IRS Tax Withholding Estimator at irs.gov
