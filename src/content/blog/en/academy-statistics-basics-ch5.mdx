...
track: academy
locale: en
title: "Statistical Estimation and Confidence Intervals"
category: "Statistics"
...
tags:
  ...
  - interval estimation
  - statistics
description: "Point versus interval estimation, what a confidence interval actually claims, and how to work out the sample size you need."
pubDate: '2026-05-12'
---
...
$$
CI = \bar{x} \pm t(\alpha /2, n-1) \times (\frac{s}{\sqrt{n}})
$$
...
$$
\begin{aligned}
&n \geq (Z_{\alpha/2} \times \sigma / E)^2 \\
&For proportion estimation: \\
&n \geq (Z_{\alpha/2})^2 \times \hat{p}(1-\hat{p}) / E^2 \quad \text{(When p̂ is unknown, use p̂ = 0.5 → maximum sample size)}
\end{aligned}
$$
