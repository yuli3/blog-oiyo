...
$$
\begin{aligned}
Portfolio Variance &= w_{1}^2\sigma_{1}^2 + w_{2}^2\sigma_{2}^2 + 2w_{1}w_{2}\sigma_{1}\sigma_{2}\rho_{12} \\
\rho &= -1: Maximum diversification benefit \\
\rho &= +1: No diversification benefit \\
\rho &= 0: Partial diversification
\end{aligned}
$$
...
$$
\begin{aligned}
E(R_{i}) &= Rf + \beta_{i} \times [E(Rm) - Rf] \\
E(R_{i}) &= Expected return of asset i \\
Rf &= Risk-free rate \\
\beta_{i} &= Beta (sensitivity to market movements) \\
