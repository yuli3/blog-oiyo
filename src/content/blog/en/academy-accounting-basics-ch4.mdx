...
track: academy
locale: en
title: "The Cash Flow Statement — Why Profit and Cash Are Not the Same Thing"
category: "Accounting"
...
$$
\text{Cash Flow Statement} = \text{Operating Activities} + \text{Investing Activities} + \text{Financing Activities}
$$
...
\begin{aligned}
&\text{Net Income} \\
&+ \text{Non-cash expenses} (\text{depreciation}, \text{amortization}) \\
&- \text{Non-cash income} (\text{gain on asset disposal}) \\
&- \text{Increases in working capital} (\text{accounts receivable} ↑, \text{inventory} ↑) \\
&+ \text{Decreases in working capital} (\text{accounts payable} ↑) \\
&= \text{Cash Flow from Operating Activities} (CFO)
\end{aligned}
$$
