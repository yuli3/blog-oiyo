...
track: academy
locale: en
title: 'Social Insurance — Medicare, Medicaid, Social Security, and Workers Comp'
category: "Finance"
...
- **Eligibility**: age 65+; or under 65 with qualifying disability; or end-stage renal disease (ESRD).

**Part A — Hospital Insurance**

- Inpatient hospital, skilled nursing facility (SNF), hospice.
- Funded by payroll taxes (FICA); no monthly premium if sufficient work credits.
...
- **FICA payroll tax**: 6.2% employee + 6.2% employer = 12.4% on wages up to the Social Security wage base (~\$168,600 in 2024)
...
- Must have qualifying work history (credits) and a severe disability expected to last 12+ months or result in death.
...
- **Benefits**: medical treatment, wage replacement (~66% of wages), permanent disability, death/survivors benefits.
...
- **Eligibility**: involuntary job loss; must actively seek work; typically 26 weeks of benefits (extended during recessions).
