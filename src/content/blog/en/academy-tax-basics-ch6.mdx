...
track: academy
locale: en
title: 'Capital Gains Tax — Stocks, ETFs, Crypto, and Real Estate Sales'
category: "Tax"
...
$$
\text{Capital Gain} = \text{Amount Realized} − \text{Adjusted Basis}
$$
...
$$
\begin{aligned}
&\text{Scenario}: \text{Sell} 100 \text{shares of ABC at} \$80 (\text{bought at} \$50, \text{held} 14 \text{months}) \\
\text{Gain} &= (\$80 − \$50) \times 100 = \$3,000 \text{long-term gain} \\
\text{At} 15\% \text{long-term rate}: \$3,000 \times 15\% &= \$450 \text{tax} \\
\text{At} 22\% \text{short-term rate} (\text{if held less than} 1 \text{year}): \$3,000 \times 22\% &= \$660 \text{tax} \\
&\text{Difference}: \$210 — \text{the cost of impatience}
\end{aligned}
$$
