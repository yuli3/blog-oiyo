...
track: academy
locale: en
title: 'Insurance Fundamentals — Comprehensive Review & Final Check'
category: "Finance"
...
- **Premium-Loss Balance**: total premiums collected = total claims paid (actuarial equivalence)
...
- **No-causation exception**: if the concealed fact did not cause the loss, the claim must still be paid.
...
- Giving clients a portion of commission as an inducement → illegal in most states (anti-rebate statutes)
...
- Non-proportional (XL / catastrophe): reinsurer pays only when loss exceeds the retention layer
