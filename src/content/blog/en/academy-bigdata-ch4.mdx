...
tags:
  ...
  - random forest
  - logistic regression
description: "Logistic regression, decision trees, random forests, SVM, naive Bayes — comparing classification algorithms."
pubDate: '2026-05-31'
---
...
$$
P(Y=1|X) = 1 / (1 + e^(-z)), z = \beta_{0} + \beta_{1}X_{1} + \beta_{2}X_{2} + ...
$$
