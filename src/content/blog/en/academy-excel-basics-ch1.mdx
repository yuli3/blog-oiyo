...
$$
\begin{aligned}
&=A1+B1 (\text{entered in} C1) \\
\to \text{Copied to} C2: &=A2+B2 (\text{adjusts automatically})
\end{aligned}
$$
...
$$
\begin{aligned}
&=MAX(A1:A10) \to Maximum value \\
&=MIN(A1:A10) \to Minimum value \\
&=LARGE(A1:A10, 2) \to 2nd-largest value \\
&=SMALL(A1:A10, 3) \to 3rd-smallest value
\end{aligned}
$$
