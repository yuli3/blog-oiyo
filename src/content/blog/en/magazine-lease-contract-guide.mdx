...
track: magazine
locale: en
title: "Renting 101: Lease Contracts and Tenant Rights"
...
tags:
  ...
  - housing
  - fraud-prevention
description: "What to check in a listing, the clauses that should stop you signing, how to protect a deposit, and how to spot rental fraud."
pubDate: '2026-05-05'
---
...
1. Landlord will not place additional liens or encumbrances on the property during the tenancy without written notice.
2. Landlord will not interfere with tenant's ability to establish legal residency at the property.
3. If the security deposit is not returned within the statutory period, interest will accrue at ___ % per day/month.
4. Tenant has the right to inspect the property condition report before paying the final move-in amount.
