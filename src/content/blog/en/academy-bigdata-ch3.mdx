...
track: academy
locale: en
title: "Statistics for Data Science — Hypothesis Testing and Distributions"
category: "Exam"
...
description: "Probability distributions, hypothesis testing (t-test/chi-square/ANOVA), p-values, Type I/II errors — the statistical foundation of data analytics."
pubDate: '2026-05-31'
---
...
&\text{Large} F \to \text{groups are different}
\end{aligned}
$$
