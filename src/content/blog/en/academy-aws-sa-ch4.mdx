...
track: academy
locale: en
title: "S3 — Infinitely Scalable Object Storage"
category: "Exam"
...
tags:
  ...
  - object storage
  - SAA
description: "S3 buckets/objects, storage classes, versioning, static website hosting, lifecycle policies, and security — mastering S3. AWS SAA."
pubDate: '2026-05-31'
---
...
photo.jpg (v1) → overwrite → photo.jpg (v2, current) → photo.jpg (v1, preserved)
