...
track: academy
locale: en
title: 'Tax Saving Guide — Payroll, W-4 Withholding, and Salary-Based Tax Reduction'
category: "Tax"
...
\begin{aligned}
&\text{Gross Pay} \\
&− \text{Federal Income Tax Withholding} \\
&− \frac{\text{State}}{\text{Local Income Tax Withholding}} \\
&− \text{Social Security Tax} (6.2\%, \text{up to} \$168,600 \text{wage base in} 2024) \\
&− \text{Medicare Tax} (1.45\%; +0.9\% \text{on wages above} \$200K \text{single} / \$250K MFJ) \\
&− 401(k) / 403(b) \text{Pre-Tax Contributions} \\
&− \frac{HSA}{\text{FSA Pre-Tax Contributions}} \\
&− \frac{\text{Health}}{\text{Dental}} / \text{Vision Insurance Premiums} (\text{pre-tax via} §125 \text{plan}) \\
&= \text{Net Pay} (\text{take-home})
\end{aligned}
$$
...
<HighlightBox title="Update your W-4 when any of these occur">
