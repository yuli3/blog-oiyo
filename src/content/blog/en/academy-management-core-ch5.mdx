...
track: academy
locale: en
title: 'Financial Management and Accounting — Reading Financial Statements and Valuing a Business'
category: "Business"
...
&= \text{Gross Profit} \\
&− \text{Selling}, \text{General} \& \text{Administrative Expenses} (SG\&A) \\
&= \text{Operating Income} (EBIT) \\
&− \text{Interest Expense} \\
&= \text{Pre-tax Income} (EBT) \\
&− \text{Income Tax} \\
&= \text{Net Income}
\end{aligned}
$$
...
## 3. Key Financial Ratio Analysis
...
## 5. Investment Decision-Making: NPV and IRR
