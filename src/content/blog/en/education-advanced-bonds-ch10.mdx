...
- **Expected return**: +10–15% per 1% point rate drop (Conversely, large losses if rates rise)
...
- **Pension accounts**: Tax deferral on bond ETF income → Maximize use of these accounts
...
Let go of the myth that "bonds are automatically safe" and the misconception that "I just need the coupon."

Understanding the rate cycle, selecting the right bonds for your purpose, and maintaining diversification — that is the essence of bond investing.
