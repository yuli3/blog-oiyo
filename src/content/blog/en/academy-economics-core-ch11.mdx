...
track: academy
locale: en
title: "International Trade Theory and Exchange Rates"
category: "Economics"
...
tags:
  ...
  - trade-policy
  - economics
description: "Ricardo's comparative advantage, the Heckscher-Ohlin theorem, tariff and non-tariff barriers, and how exchange rates get determined."
pubDate: '2026-05-12'
---
...
- So Country B has a comparative advantage in rice, and Country A in computers
...
$$
\begin{aligned}
\text{Direct quote} (\text{US perspective}): 1 EUR &= \$1.10 \\
\text{Indirect quote}: \$1 &= 0.91 EUR
\end{aligned}
$$
...
$$
\begin{aligned}
\text{Balance of Payments} &= \text{Current Account} + \text{Capital} \& \text{Financial Account} \\
\text{Current Account} &= \text{Trade in goods} + \text{Trade in services} \\
&+ \text{Primary income} + \text{Secondary income}
\end{aligned}
$$
