...
<DividendCalculator client:visible />
...
$$
\text{Dividend Yield} = \text{Annual Dividends per Share} \div \text{Current Share Price} \times 100
$$
...
$$
\text{Payout Ratio} = \text{Dividends per Share} \div \text{Earnings per Share} (EPS) \times 100
$$
