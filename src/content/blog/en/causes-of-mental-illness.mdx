...
description: >-
  Exploring the fundamental causes of various mental illnesses, we highlight the
  blind spots of the existing diagnostic system that focuses only on symptoms
