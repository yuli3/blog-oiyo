...
locale: en
track: academy
title: "Crypto Investment Risks — Volatility, Hacks, and Scams Fully Analyzed"
category: Crypto
...
**Ponzi scheme** — New investors' money is used to pay existing investors → Collapses when new investors dry up
...
- When providing liquidity, price changes between the paired assets can result in a worse outcome than simply holding
