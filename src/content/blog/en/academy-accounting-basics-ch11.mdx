...
track: academy
locale: en
title: "Working Capital & Turnover Ratios — Reading Liquidity and Cash Conversion Speed"
category: "Accounting"
...
$$
\text{Current Ratio} = \$800,000 / \$400,000 \times 100 = 200\%
$$
...
$$
\text{Quick Ratio} = (\text{Current Assets} − \text{Inventory}) / \text{Current Liabilities} \times 100
$$
...
$$
\text{Quick Ratio} = (\$800,000 − \$300,000) / \$400,000 \times 100 = 125\%
$$
...
\text{Average AR} &= (\text{Beginning AR} + \text{Ending AR}) / 2
\end{aligned}
$$
...
\text{Average Inventory} &= (\text{Beginning Inventory} + \text{Ending Inventory}) / 2
\end{aligned}
$$
