...
track: academy
locale: en
title: "The Balance Sheet — How to Read a Company Through Assets, Liabilities, and Equity"
category: "Accounting"
...
(\text{What the company has}) &= (\text{What it owes}) + (\text{What it owns})
\end{aligned}
$$
...
$$
\text{Equity} = \text{Assets} - \text{Liabilities} = \text{Net Assets}
$$
