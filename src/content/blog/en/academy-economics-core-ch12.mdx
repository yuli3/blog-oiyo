...
track: academy
locale: en
title: "Welfare Economics and Income Distribution"
category: "Economics"
...
tags:
  ...
  - gini-coefficient
  - economics
description: "Pareto efficiency, social welfare functions, the Gini coefficient and Lorenz curve — and where redistribution policy stops working."
pubDate: '2026-05-12'
---
...
$$
\begin{aligned}
\text{Gini coefficient} &= (\text{Area between equality line and Lorenz curve}) \\
&/ (\text{Area of triangle below equality line}) \\
&\text{Range}: 0 (\text{perfect equality}) to 1 (\text{perfect inequality})
\end{aligned}
$$
