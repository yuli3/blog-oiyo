...
**Capital Gains Tax Formula** — Tax = (Amount Realized − Adjusted Basis − Allowable Deductions) × Applicable Rate
...
**Partial exclusion formula** — (Months of ownership and use / 24 months) × Maximum exclusion
...
- **Plus**: Net Investment Income Tax (NIIT) of 3.8% may apply (Single MAGI > $200,000; MFJ MAGI > $250,000)

- The difference between holding 11 months vs. 13 months can be enormous. A $200,000 gain taxed at 37% ordinary income = $74,000 tax. The same gain taxed at 15% LTCG = $30,000 tax.
...
- **Note**: Routine repairs and maintenance do NOT increase basis. (Painting, fixing a leaky faucet, replacing a broken window = expenses, not basis)
...
3. Defer high-gain properties through § 1031 or hold until death (Stepped-up basis at death eliminates built-in gain entirely — IRC § 1014)
...
- Real estate professionals: rental income may qualify as non-passive, removing it from the NIIT base
