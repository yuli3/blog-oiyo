...
track: academy
locale: en
title: 'Hypothesis Testing — Using Data to Evaluate Claims'
category: "Statistics"
...
$$
t = \frac{\bar{x} - \mu _0}{\frac{s}{\sqrt{n}}} \quad \text{(degrees of freedom: n−1)}
$$

### Two-Sample Independent t-Test
Comparing means of two groups (e.g., clinical trial: treatment vs control).
$$
t = (\bar{x}_1 - \bar{x}_2) / \sqrt{s_{1}^2/n_{1} + s_{2}^2/n_{2}}
$$
