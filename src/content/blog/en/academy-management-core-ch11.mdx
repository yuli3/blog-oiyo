...
track: academy
locale: en
title: 'Global Management — Multinational Corporations, Market Entry, and Cross-Cultural Leadership'
category: "Business"
...
## 3. MNC Strategy Types

### (1) Global vs. Local Pressures

**Integration-Responsiveness (I-R) Framework**:

| | Low local responsiveness pressure | High local responsiveness pressure |
|---|---|---|
| **High global integration pressure** | Global Strategy | Transnational |
| **Low global integration pressure** | International | Multi-domestic |
