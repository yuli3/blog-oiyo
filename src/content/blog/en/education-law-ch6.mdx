...
Creditor → Debtor (right to demand) · (duty to perform)
...
- **Joint and Several Guarantee**: no benefit of excussion; creditor may directly claim from guarantor → Most commercial bank loan guarantees are joint and several
...
**Step 2: Choose a remedy**
  ...
  1. Demand proper performance (replacement vehicle)
  2. Claim damages (difference in value)
  3. Rescind the contract + restoration (return of purchase price)
