...
- **静的モデル (Static Model)**: 「今年60歳の人が死亡する確率は2%である。」（現在の観測値を固定）
...
<LectureBarChart
  ...
  data={[
    ...
    { name: "2000年", value: 75.9, color: "#94a3b8" },
    { name: "2010年", value: 80.2, color: "#60a5fa" },
    { name: "2020年", value: 83.5, color: "#3b82f6" },
    { name: "2030年(予想)", value: 86.8, color: "#2563eb" },
  ]}
  client:load
/>
...
- [**第7章：損害保険数理の基礎**](/ja/education-actuarial-science-ch7/)
