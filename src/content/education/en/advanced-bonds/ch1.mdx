...
language: "en"
summary: "Master the fundamental mechanics of the bond market. Explore the inverse relationship between interest rates and bond prices, and learn how to calculate Yield to Maturity (YTM) for advanced valuation."
keyTerms:
  [
    "Bond Pricing",
