...
language: en
summary: "Learn about non-parametric statistics, an analysis method for situations where normal distribution assumptions cannot be made, and the principles of Principal Component Analysis (PCA) for compressing numerous variables into key ones."
keyTerms:
  [
