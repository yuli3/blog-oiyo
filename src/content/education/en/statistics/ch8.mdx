...
language: en
summary: "Understand the characteristics of time-ordered data where sequence matters, and learn the basics of forecasting using stationarity and ARIMA models."
keyTerms: ["Time Series", "Stationarity", "Autocorrelation", "ARIMA"]
---
