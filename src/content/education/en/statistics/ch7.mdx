...
language: en
summary: "Learn the principles of Logistic Regression and the concept of the Odds Ratio, used when the outcome is categorical data like 'Pass/Fail' or 'Fraud/Normal' rather than a numerical value."
keyTerms: ["Logistic Regression", "Sigmoid Function", "Odds Ratio", "Threshold"]
---
