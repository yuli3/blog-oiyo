...
language: "en"
summary: "Systematically organize the intrinsic values (public interest, justice) that administration should pursue and the instrumental values (efficiency, effectiveness) required to achieve them."
keyTerms:
  ["Public Interest", "Social Equity", "Efficiency", "Effectiveness", "Admin Ethics", "Values"]
---
