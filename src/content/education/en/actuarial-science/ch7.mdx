...
language: en
summary: "Learn how to design probability models for the number of accidents (Frequency) and the loss per accident (Severity), the core of non-life insurance sectors like auto, fire, and liability."
keyTerms: ["Ruin Probability", "Surplus Process", "Stop-Loss Reinsurance", "Reinsurance"]
---
