...
language: en
summary: "Learn about the actuarial changes brought by the introduction of IFRS17, which values insurance liabilities at 'market value' rather than cost, as well as the concept of CSM (Contract Service Margin) and future challenges for actuaries."
keyTerms: ["IFRS17", "Market Valuation", "CSM (Contract Service Margin)", "RA (Risk Adjustment)"]
---
