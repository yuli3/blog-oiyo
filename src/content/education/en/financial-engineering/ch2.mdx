...
language: en
summary: "Understand the fundamental concept of compounding and discounting, and how the value of money changes across time."
keyTerms: ["Present Value (PV)", "Future Value (FV)", "Compounding", "Discounting", "NPV"]
---
