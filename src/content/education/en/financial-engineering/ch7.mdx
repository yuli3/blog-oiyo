...
language: en
summary: "Learn numerical techniques that use random numbers to generate virtual scenarios and calculate the value of complex derivatives that are difficult to solve with closed-form formulas."
keyTerms: ["Monte Carlo", "Random Number", "Scenario Analysis", "Path Dependency"]
---
