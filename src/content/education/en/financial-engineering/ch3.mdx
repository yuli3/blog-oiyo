...
language: en
summary: "Learn the core concepts of derivatives and how forward contracts are used to manage price risk in an uncertain future."
keyTerms: ["Derivative", "Forward Contract", "Futures", "Hedging", "Counterparty Risk"]
---
