...
language: "en"
summary: "Understand the flow of capital that drives corporate growth. Master the concepts of the Time Value of Money (TVM), Capital Budgeting (NPV/IRR), and the strategic trade-off between risk and return."
keyTerms:
  [
