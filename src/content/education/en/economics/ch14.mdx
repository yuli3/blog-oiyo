...
language: "en"
summary: "Discuss the policy debates over whether government intervention is necessary. Analyze rational expectations, Ricardian Equivalence, and the difference between rules and discretion."
keyTerms:
  [
