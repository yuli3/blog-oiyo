...
language: "en"
summary: "Analyze the causes of unemployment and inflation, the two major challenges of macroeconomics, and study the Phillips curve, which represents the relationship between them."
keyTerms:
  [
