...
language: "en"
summary: "Learn the IS-LM model, which represents the simultaneous equilibrium of the product and money markets, and through it, master the principles of Aggregate Demand (AD) and Aggregate Supply (AS)."
keyTerms:
  [
    "IS Curve",
    "LM Curve",
...
<ISLMChart title="IS-LM Equilibrium" />
